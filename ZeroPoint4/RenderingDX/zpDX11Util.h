...
ZP_FORCE_INLINE DXGI_FORMAT __zpToDX( zpDisplayFormat t ) {
	...
	case ZP_DISPLAY_FORMAT_D32_FLOAT: return DXGI_FORMAT_D32_FLOAT;
		...
		// Compressed
	case ZP_DISPLAY_FORMAT_DXT1: return DXGI_FORMAT_BC1_UNORM;
	case ZP_DISPLAY_FORMAT_DXT3: return DXGI_FORMAT_BC3_UNORM;
	case ZP_DISPLAY_FORMAT_DXT5: return DXGI_FORMAT_BC5_UNORM;
...
ZP_FORCE_INLINE zpDisplayFormat __dxToZP( DXGI_FORMAT t ) {
	...
	case DXGI_FORMAT_D32_FLOAT: return ZP_DISPLAY_FORMAT_D32_FLOAT;
		...
		// Compressed
	case DXGI_FORMAT_BC1_UNORM: return ZP_DISPLAY_FORMAT_DXT1;
	case DXGI_FORMAT_BC3_UNORM: return ZP_DISPLAY_FORMAT_DXT3;
	case DXGI_FORMAT_BC5_UNORM: return ZP_DISPLAY_FORMAT_DXT5;
