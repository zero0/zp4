...
struct ClassType {
	...
	static zpMap<HSQUIRRELVM, ClassTypeData> s_classTypeDataMap;
    ...
    static inline bool hasClassTypeData(HSQUIRRELVM vm) {
		...
		return s_classTypeDataMap.containsKey( vm );
    }
...
zpMap<HSQUIRRELVM, ClassTypeData> ClassType<C>::s_classTypeDataMap;
}
