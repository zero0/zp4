...
enum TextureCubeFaceOrder
{
	TEXTURE_CUBE_FACE_P_X,
	TEXTURE_CUBE_FACE_N_X,

	TEXTURE_CUBE_FACE_P_Y,
	TEXTURE_CUBE_FACE_N_Y,

	TEXTURE_CUBE_FACE_P_Z,
	TEXTURE_CUBE_FACE_N_Z,

	TextureCubeFaceOrder_Count
};
