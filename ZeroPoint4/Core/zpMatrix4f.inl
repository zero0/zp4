...
ZP_FORCE_INLINE const zpVector4f& zpMatrix4f::getRow( zp_uint row ) const
{
    return m_rows[ row ];
}
ZP_FORCE_INLINE void zpMatrix4f::setRow( zp_uint row, const zpVector4f& v )
{
    m_rows[ row ] = v;
}

ZP_FORCE_INLINE void zpMatrix4f::setIdentity()
{
    m_m1 = zpVector4f( 1, 0, 0, 0 );
    m_m2 = zpVector4f( 0, 1, 0, 0 );
    m_m3 = zpVector4f( 0, 0, 1, 0 );
    m_m4 = zpVector4f( 0, 0, 0, 1 );
}
